...
use crate::player_system::{
    player_startup_system, player_update_system, player_visibility_debug_update_system,
};
...
impl Plugin for PlayerPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(Startup, player_startup_system)
            ...
            .add_systems(Update, player_visibility_debug_update_system);
    }
}
